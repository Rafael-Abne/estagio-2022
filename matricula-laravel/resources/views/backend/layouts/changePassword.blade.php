            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">Confirme sua Nova Senha</label>
    
                            <div class="col-md-6">
                                <input id="new_confirm_password" type="password" required class="form-control" name="new_confirm_password" autocomplete="current-password">
                            </div>
                        </div>
